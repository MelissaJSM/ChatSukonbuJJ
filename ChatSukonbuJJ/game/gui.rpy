...
## 인-게임 글자에 사용됩니다.
define gui.text_font = "digi.ttf"

## 캐릭터의 이름에 사용됩니다.
define gui.name_text_font = "CookieRun Regular.ttf"

## 인터페이스에 사용됩니다.
define gui.interface_text_font = "gyeongi.ttf"
...
## 현재 샘플 1번 디자인으로 좌표값이 설정되어있다. -- 23.07.11 J --
...
## 이 함수가 있는지 확인이안되고있다!! -- 23.07.11 J -- 
define gui.dialogue_weight = 50
